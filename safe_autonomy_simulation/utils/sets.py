...
class MutableSet:
    ...
    def __init__(self, elements: list = []):
        self._set = {id(element): element for element in elements}
    ...
    def difference(self, other: typing.Self) -> typing.Self:
        ...
        """
        return MutableSet(elements=[element for element in self if element not in other])
    ...
    def symmetric_difference_update(self, other: typing.Self):
        ...
        other : MutableSet
            Set to take the symmetric difference with
        """
        self._set = {id(element): element for element in self.difference(other).union(other.difference(self))}
...
class TypedSet(typing.Generic[T], MutableSet):
    ...
    def copy(self) -> typing.Self:
        ...
        TypedSet
            Shallow copy of the set
        """
        return TypedSet(elements=list(self._set.values()))
    ...
    def difference(self, other: typing.Self) -> typing.Self:
        ...
        TypedSet
            New set with elements in this set but not in the other set
        """
        return TypedSet(elements=[element for element in self if element not in other])
    ...
    def intersection(self, other: typing.Self) -> typing.Self:
        ...
        TypedSet
            New set with elements common to both sets
        """
        return TypedSet(elements=[element for element in self if element in other])
    ...
    def union(self, other: typing.Self) -> typing.Self:
        ...
        TypedSet
            New set with all elements from both sets
        """
        return TypedSet(elements=list(self) + list(other))
    ...
    def __repr__(self) -> str:
        return f"TypedSet({[element for element in self]})"
